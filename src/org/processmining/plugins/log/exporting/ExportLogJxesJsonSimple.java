...
@UIExportPlugin(description = "JXES files (JSON Simple)", extension = "json")
public class ExportLogJxesJsonSimple extends AbstractLogExporter {
	...
	public static void export(XLog log, File file) throws IOException {
		...
		JxesJsonSimpleSerializer logSerializer = new JxesJsonSimpleSerializer();
